...
const scrollHeader = () => {
    ...
    if(this.scrollY >=50){
        header.classList.add("border-b", "border-orange-500")
    } else {
        header.classList.remove("border-b", "border-orange-500")
    }
}
...
sr.reveal(`.home__data, .about__top, .popular__top, .client__top, .client__container, .review__top, .review__swiper, .footer__icon, .footer__content, .copy__right`)
